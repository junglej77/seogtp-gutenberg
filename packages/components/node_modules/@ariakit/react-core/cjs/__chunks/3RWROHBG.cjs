...
var _3GUEWEPJcjs = require('./3GUEWEPJ.cjs');
...
function findById(items, id, baseId) {
  return items.findIndex((item, index) => {
    var _a;
    const itemId = _3GUEWEPJcjs.getCollectionRendererItemId.call(void 0, item, index, baseId);
...
function useCompositeRenderer(_a) {
  ...
  store = store || context;
  const orientation = _DMH7HONVcjs.useStoreState.call(void 0, 
    store,
  ...
  const items = _DMH7HONVcjs.useStoreState.call(void 0, store, (state) => {
    var _a2;
  ...
  const activeId = _DMH7HONVcjs.useStoreState.call(void 0, store, "activeId");
  ...
  return _3GUEWEPJcjs.useCollectionRenderer.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
    id,
    store,
    orientation,
    persistentIndices
...
var CompositeRenderer = _M5IWBORBcjs.forwardRef.call(void 0, function CompositeRenderer2(props) {
