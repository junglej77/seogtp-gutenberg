...
var usePopoverDisclosureArrow = _M5IWBORBcjs.createHook.call(void 0, function usePopoverDisclosureArrow2(_a) {
  var _b = _a, { store, placement } = _b, props = _3IVNQNIVcjs.__objRest.call(void 0, _b, ["store", "placement"]);
  const context = _AMARRBCFcjs.usePopoverContext.call(void 0, );
  store = store || context;
...
var PopoverDisclosureArrow = _M5IWBORBcjs.forwardRef.call(void 0, 
