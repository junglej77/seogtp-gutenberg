...
var _CEAT6DDRcjs = require('./CEAT6DDR.cjs');
...
var useFormControl = _M5IWBORBcjs.createHook.call(void 0, 
  function useFormControl2(_a) {
    ...
    const getItem = _react.useCallback.call(void 0, 
      (item) => {
        const nextItem = _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, item), { id: id || item.id, name, type: "field" });
        if (getItemProp) {
    ...
    const touchOnBlurProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, touchOnBlur);
    ...
    props = _RRCMCI3Icjs.useCollectionItem.call(void 0, _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, { store }, props), { name, getItem }));
    return props;
  }
);
var FormControl = _M5IWBORBcjs.memo.call(void 0, 
  _M5IWBORBcjs.forwardRef.call(void 0, function FormControl2(props) {
