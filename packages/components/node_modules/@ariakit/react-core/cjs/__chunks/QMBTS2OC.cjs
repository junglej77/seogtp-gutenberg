...
var _K32UV4VJcjs = require('./K32UV4VJ.cjs');
...
var usePortal = _M5IWBORBcjs.createHook.call(void 0, function usePortal2(_a) {
  var _b = _a, {
    preserveTabOrder,
  ...
  const refProp = _WT6AUJWVcjs.useMergeRefs.call(void 0, ref, props.ref);
...
var Portal = _M5IWBORBcjs.forwardRef.call(void 0, function Portal2(props) {
