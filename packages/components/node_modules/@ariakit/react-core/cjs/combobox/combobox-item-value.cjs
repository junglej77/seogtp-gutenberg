...
var useComboboxItemValue = _M5IWBORBcjs.createHook.call(void 0, function useComboboxItemValue2(_a) {
  var _b = _a, { store, value, userValue } = _b, props = _3IVNQNIVcjs.__objRest.call(void 0, _b, ["store", "value", "userValue"]);
  const context = _F4DU6MSGcjs.useComboboxScopedContext.call(void 0, );
  store = store || context;
  const itemContext = _react.useContext.call(void 0, _F4DU6MSGcjs.ComboboxItemValueContext);
  const itemValue = value != null ? value : itemContext;
  const inputValue = _DMH7HONVcjs.useStoreState.call(void 0, store, (state) => userValue != null ? userValue : state == null ? void 0 : state.value);
...
var ComboboxItemValue = _M5IWBORBcjs.forwardRef.call(void 0, function ComboboxItemValue2(props) {
