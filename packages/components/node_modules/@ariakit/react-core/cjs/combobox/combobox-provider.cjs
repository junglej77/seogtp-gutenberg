...
var _R3DZOXNRcjs = require('../__chunks/R3DZOXNR.cjs');


var _F4DU6MSGcjs = require('../__chunks/F4DU6MSG.cjs');
require('../__chunks/N2JBBOXS.cjs');
...
function ComboboxProvider(props = {}) {
  const store = _R3DZOXNRcjs.useComboboxStore.call(void 0, props);
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _F4DU6MSGcjs.ComboboxContextProvider, { value: store, children: props.children });
}
