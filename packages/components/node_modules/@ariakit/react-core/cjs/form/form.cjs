...
var useForm = _M5IWBORBcjs.createHook.call(void 0, function useForm2(_a) {
  var _b = _a, {
    store,
  ...
  const defaultValues = _WT6AUJWVcjs.useInitialValue.call(void 0, values);
  ...
  const onSubmit = _WT6AUJWVcjs.useEvent.call(void 0, (event) => {
  ...
  const onReset = _WT6AUJWVcjs.useEvent.call(void 0, (event) => {
  ...
  props = _WT6AUJWVcjs.useWrapElement.call(void 0, 
    props,
    (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _CEAT6DDRcjs.FormScopedContextProvider, { value: store, children: element }),
    [store]
  );
...
var Form = _M5IWBORBcjs.forwardRef.call(void 0, function Form2(props) {
