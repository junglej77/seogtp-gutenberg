...
var _C6F3GNG7cjs = require('../__chunks/C6F3GNG7.cjs');
...
var TagName = "span";
var useMenuButtonArrow = _M5IWBORBcjs.createHook.call(void 0, 
  function useMenuButtonArrow2(_a) {
    var _b = _a, { store } = _b, props = _3IVNQNIVcjs.__objRest.call(void 0, _b, ["store"]);
    const context = _TTVWSMCCcjs.useMenuContext.call(void 0, );
    store = store || context;
    props = _C6F3GNG7cjs.usePopoverDisclosureArrow.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
var MenuButtonArrow = _M5IWBORBcjs.forwardRef.call(void 0, function MenuButtonArrow2(props) {
