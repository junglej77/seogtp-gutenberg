...
var _32EK4BGYcjs = require('./32EK4BGY.cjs');
...
function useCollectionRenderer(_a) {
  ...
  var _a2, _b2;
  const context = _32EK4BGYcjs.useCollectionContext.call(void 0, );
  store = store || context;
  const items = _DMH7HONVcjs.useStoreState.call(void 0, 
    store,
  ...
  const baseId = _WT6AUJWVcjs.useId.call(void 0, props.id);
  const horizontal = orientation === "horizontal";
  const elements = _react.useMemo.call(void 0, () => /* @__PURE__ */ new Map(), []);
  const [elementsUpdated, updateElements] = _WT6AUJWVcjs.useForceUpdate.call(void 0, );
  ...
  const processVisibleIndicesEvent = _WT6AUJWVcjs.useEvent.call(void 0, processVisibleIndices);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnScrollProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, renderOnScroll);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnResizeProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, renderOnResize);
  _react.useEffect.call(void 0, () => {
...
var CollectionRenderer = _M5IWBORBcjs.forwardRef.call(void 0, function CollectionRenderer2(props) {
