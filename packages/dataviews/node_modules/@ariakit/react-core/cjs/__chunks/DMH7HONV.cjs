...
function useStoreProps(store, props, key, setKey) {
  ...
  const propsRef = _WT6AUJWVcjs.useLiveRef.call(void 0, { value, setValue });
...
function useStore(createStore, props) {
  ...
  _WT6AUJWVcjs.useSafeLayoutEffect.call(void 0, () => _store.init.call(void 0, store), [store]);
  ...
  const updateStore = _WT6AUJWVcjs.useEvent.call(void 0, () => {
