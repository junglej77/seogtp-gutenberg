...
var _U46ICSYFcjs = require('./U46ICSYF.cjs');
...
function useToolbarStoreProps(store, update, props) {
  return _U46ICSYFcjs.useCompositeStoreProps.call(void 0, store, update, props);
}
function useToolbarStore(props = {}) {
  const [store, update] = _DMH7HONVcjs.useStore.call(void 0, Core.createToolbarStore, props);
