...
var _C55AGIGAcjs = require('./C55AGIGA.cjs');
...
function useDialogStoreProps(store, update, props) {
  return _C55AGIGAcjs.useDisclosureStoreProps.call(void 0, store, update, props);
}
function useDialogStore(props = {}) {
  const [store, update] = _DMH7HONVcjs.useStore.call(void 0, Core.createDialogStore, props);
