...
var _ZJMEXN3Ncjs = require('./ZJMEXN3N.cjs');
...
var TagName = "div";
var useGroup = _M5IWBORBcjs.createHook.call(void 0, 
  function useGroup2(props) {
    ...
    props = _WT6AUJWVcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _ZJMEXN3Ncjs.GroupLabelContext.Provider, { value: setLabelId, children: element }),
      []
    );
...
var Group = _M5IWBORBcjs.forwardRef.call(void 0, function Group2(props) {
