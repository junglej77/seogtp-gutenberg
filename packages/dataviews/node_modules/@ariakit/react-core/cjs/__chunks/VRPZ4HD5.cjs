...
var useDisclosureContent = _M5IWBORBcjs.createHook.call(void 0, function useDisclosureContent2(_a) {
  ...
  const otherElement = _DMH7HONVcjs.useStoreState.call(void 0, store.disclosure, "contentElement");
  ...
  props = _WT6AUJWVcjs.useWrapElement.call(void 0, 
    props,
    (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _HHTQYHYLcjs.DialogScopedContextProvider, { value: store, children: element }),
    [store]
  );
  const hidden = isHidden(mounted, props.hidden, alwaysVisible);
  const styleProp = props.style;
  const style = _react.useMemo.call(void 0, () => {
    if (hidden) return _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, styleProp), { display: "none" });
    return styleProp;
  }, [hidden, styleProp]);
  props = _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
    ...
    ref: _WT6AUJWVcjs.useMergeRefs.call(void 0, id ? store.setContentElement : null, ref, props.ref),
    style
  });
  return _misc.removeUndefinedValues.call(void 0, props);
});
var DisclosureContentImpl = _M5IWBORBcjs.forwardRef.call(void 0, function DisclosureContentImpl2(props) {
  const htmlProps = useDisclosureContent(props);
  return _M5IWBORBcjs.createElement.call(void 0, TagName, htmlProps);
});
var DisclosureContent = _M5IWBORBcjs.forwardRef.call(void 0, function DisclosureContent2(_a) {
  var _b = _a, {
    unmountOnHide
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, DisclosureContentImpl, _3IVNQNIVcjs.__spreadValues.call(void 0, {}, props));
});
