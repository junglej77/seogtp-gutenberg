...
var TagName = "button";
var useTagRemove = _M5IWBORBcjs.createHook.call(void 0, 
  function useTagRemove2(_a) {
    ...
    const setRemoveId = _react.useContext.call(void 0, _N2JBBOXScjs.TagRemoveIdContext);
    const valueFromContext = _react.useContext.call(void 0, _N2JBBOXScjs.TagValueContext);
    ...
    const removeOnClickProp = _WT6AUJWVcjs.useBooleanEvent.call(void 0, removeOnClick);
    ...
    props = _3IVNQNIVcjs.__spreadProps.call(void 0, _3IVNQNIVcjs.__spreadValues.call(void 0, {
      ...
      onClick,
      render: withinTag ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _6UCNERDTcjs.Role.span, { render: props.render }) : props.render
    });
    return props;
  }
);
var TagRemove = _M5IWBORBcjs.forwardRef.call(void 0, function TagRemove2(props) {
