...
export async function createUser(username, {
  ...
  await page.$eval('#email', (el, value) => el.value = value, snakeCase(username) + '@example.com');
  if (firstName) {
    await page.$eval('#first_name', (el, value) => el.value = value, firstName);
  }
  if (lastName) {
    await page.$eval('#last_name', (el, value) => el.value = value, lastName);
  }
  if (role) {
