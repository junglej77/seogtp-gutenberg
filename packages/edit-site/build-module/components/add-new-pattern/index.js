...
export default function AddNewPattern() {
  ...
  return /*#__PURE__*/_jsxs(_Fragment, {
    children: [addNewPatternLabel && /*#__PURE__*/_jsx(DropdownMenu, {
      controls: controls,
      icon: null,
      toggleProps: {
        variant: 'primary',
    ...
    }), showPatternModal && /*#__PURE__*/_jsx(CreatePatternModal, {
      onClose: () => setShowPatternModal(false),
      onSuccess: handleCreatePattern,
      onError: handleError
    }), showTemplatePartModal && /*#__PURE__*/_jsx(CreateTemplatePartModal, {
      ...
      onChange: async event => {
        ...
        try {
          ...
          __('Imported "%s" from JSON.'), pattern.title.raw), {
            type: 'snackbar',
