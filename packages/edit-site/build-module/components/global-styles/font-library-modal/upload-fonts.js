...
import { __experimentalSpacer as Spacer, __experimentalText as Text, __experimentalVStack as VStack, Button, DropZone, Notice, FormFileUpload, FlexItem, ProgressBar } from '@wordpress/components';
...
function UploadFonts() {
  ...
  const handleFilesUpload = async files => {
    ...
    if (allowedFiles.length > 0) {
      ...
      const message = hasInvalidFiles ? __('对不起，您不允许上传此文件类型。') : __('没有找到要安装的字体。');
      setNotice({
        type: 'error',
        message
      });
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsx(DropZone, {
      ...
      children: [notice && /*#__PURE__*/_jsxs(Notice, {
        status: notice.type,
        __unstableHTML: true,
        onRemove: () => setNotice(null),
        children: [notice.message, notice.errors && /*#__PURE__*/_jsx("ul", {
          children: notice.errors.map((error, index) => /*#__PURE__*/_jsx("li", {
            children: error
          }, index))
        })]
      }), isUploading && /*#__PURE__*/_jsx(FlexItem, {
        children: /*#__PURE__*/_jsx("div", {
          className: "font-library-modal__upload-area",
          children: /*#__PURE__*/_jsx(ProgressBar, {})
        })
      }), !isUploading && /*#__PURE__*/_jsx(FormFileUpload, {
        ...
        children: __('上传的字体出现在库中，可以在主题中使用。支持的格式:.ttf、。otf、。woff、。woff2。')
      })]
    })]
  });
}
