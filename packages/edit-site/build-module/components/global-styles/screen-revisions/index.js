...
function ScreenRevisions() {
  ...
  return /*#__PURE__*/_jsxs(_Fragment, {
    children: [/*#__PURE__*/_jsx(ScreenHeader, {
      ...
      description: __('点击以前保存的样式预览它们。要将选定的版本恢复到编辑器，请点击“应用”。准备好后，使用Save按钮保存更改。'),
      onBack: onCloseRevisions
    }), !hasRevisions && /*#__PURE__*/_jsx(Spinner, {
      className: "edit-site-global-styles-screen-revisions__loading"
    }), hasRevisions && (editorCanvasContainerView === 'global-styles-revisions:style-book' ? /*#__PURE__*/_jsx(StyleBook, {
      userConfig: currentlySelectedRevision,
      isSelected: () => {},
      onClose: () => {
        setEditorCanvasContainerView('global-styles-revisions');
      }
    }) : /*#__PURE__*/_jsx(Revisions, {
      blocks: blocks,
      userConfig: currentlySelectedRevision,
    ...
    }), isLoadingRevisionWithUnsavedChanges && /*#__PURE__*/_jsx(ConfirmDialog, {
      ...
      size: "medium",
      children: __('你确定要应用这个修改吗?任何未保存的更改都将丢失。')
    })]
  });
}
