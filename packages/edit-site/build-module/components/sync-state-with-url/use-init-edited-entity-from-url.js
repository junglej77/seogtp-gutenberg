...
// 模式类型
PATTERN_TYPES } from '../../utils/constants';
...
function useResolveEditedEntityAndContext({
  ...
  const {
    ...
    const _homepageId = siteData?.show_on_front === 'page' && ['number', 'string'].includes(typeof siteData.page_on_front) && !!+siteData.page_on_front // 检查是否为零(`0`)
