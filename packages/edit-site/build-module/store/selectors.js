...
export const getCanUserCreateMedia = createRegistrySelector(select => () => {
  deprecated(`wp.data.select( 'core/edit-site' ).getCanUserCreateMedia()`, {
    since: '6.7',
...
export const __experimentalGetInsertionPoint = createRegistrySelector(select => () => {
  deprecated(`select( 'core/edit-site' ).__experimentalGetInsertionPoint`, {
    since: '6.5',
    version: '6.7'
  });
 ...
 */
export const getCurrentTemplateTemplateParts = createRegistrySelector(select => createSelector(() => {
  deprecated(`select( 'core/edit-site' ).getCurrentTemplateTemplateParts()`, {
    since: '6.7',
    version: '6.9',
...
export function getCurrentTemplateNavigationPanelSubMenu() {
  deprecated("dispatch( 'core/edit-site' ).getCurrentTemplateNavigationPanelSubMenu", {
    since: '6.2',
    version: '6.4'
  });
}
