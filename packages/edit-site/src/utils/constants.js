...
export const {
	PATTERN_TYPES, // 模式类型
	PATTERN_DEFAULT_CATEGORY, // 默认模式分类
	PATTERN_USER_CATEGORY, // 用户模式分类
...
export const FOCUSABLE_ENTITIES = [
	TEMPLATE_PART_POST_TYPE, // 模板部件
	NAVIGATION_POST_TYPE, // 导航
	PATTERN_TYPES.user, // 用户模式
];

// 文章类型标签
export const POST_TYPE_LABELS = {
	[ TEMPLATE_POST_TYPE ]: __( 'Template' ), // 模板标签
	[ TEMPLATE_PART_POST_TYPE ]: __( 'Template part' ), // 模板部件标签
	[ PATTERN_TYPES.user ]: __( 'Pattern' ), // 模式标签
