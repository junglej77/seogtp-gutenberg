...
export const saveDirtyEntities = ({
  ...
  Promise.all(pendingSavedRecords).then(values => {
    ...
    if (values.some(value => typeof value === 'undefined')) {
      registry.dispatch(noticesStore).createErrorNotice(__('网站更新失败.'));
    } else {
      registry.dispatch(noticesStore).createSuccessNotice(__('网站更新成功.'), {
        type: 'snackbar',
        id: saveNoticeId,
        actions: [{
          label: __('去查看网站'),
...
//# sourceMappingURL=private-actions源文件备份.js.map