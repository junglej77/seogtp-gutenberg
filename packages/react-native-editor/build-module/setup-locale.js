 ...
 */
export default ((locale, extraTranslations, getDefaultTranslation, pluginTranslations = []) => {
  const setDomainLocaleData = ({
    getTranslation,
    domain = 'default'
  }) => {
  ...
  }, ...pluginTranslations].forEach(setDomainLocaleData);
});
//# sourceMappingURL=setup-locale.js.map